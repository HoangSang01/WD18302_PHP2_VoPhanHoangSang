<nav class=" px-0 mx-5 rounded shadow-none z-index-2 navbar navbar-main navbar-expand-lg" navbar-scroll="true"
            ...
            <div class="container px-2 py-1 min-w-100">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="mb-0 font-weight-bold breadcrumb-text  text-dark ">Thêm Khóa Học</h6>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control ps-0" placeholder="Tìm kiếm">
                        </div>
                    </div>
                    <ul class="navbar-nav  justify-content-end">
                            ...
                            <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="py-1 d-flex">
                                            <div class="my-auto">
                                                <img src="./resources/assets/admin/img/team-2.jpg" class="avatar avatar-sm  me-3 "
                                                    alt="user image">
                                            </div>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="py-1 d-flex">
                                            <div class="my-auto">
                                                <img src="./resources/assets/admin/img/small-logos/logo-spotify.svg"
                        ...
                        <li class="nav-item dropdown d-flex align-items-center">
                            <div class="avatar avatar-sm position-relative">
                                <img src="./resources/assets/admin/img/team-1.jpg" alt="profile_image" class="w-100 border-radius-md">
                            </div>
                        </li>
                        </a>
                        </li>
