<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand d-flex align-items-center m-0" href="#" target="_blank">
                <img class="navbar-brand-img" src="../resources/assets/admin/img/logo-ct.png" alt>
                <span class="font-weight-bold ms-2">TRANG QUẢN TRỊ</span>
            </a>
        </div>
        <div class="collapse navbar-collapse px-3  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="#" class="nav-link text-white opacity-9" aria-controls="" role="button"
                        aria-expanded="false">
                        <div
                ...
                <li class="nav-item">
                    <a href="#pagesExamples" class="nav-link text-white opacity-9" aria-controls="pagesExamples"
                        ...
                        <span class="nav-link-text ms-2">Thêm khóa học</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#applicationsExamples" class="nav-link text-white opacity-9"
                        ...
                        <span class="nav-link-text ms-2">Danh sách</span>
                    </a>
                </li>
            </ul>
        </div>
