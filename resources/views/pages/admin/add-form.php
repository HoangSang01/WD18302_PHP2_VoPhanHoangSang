<div class="px-5 py-4 container-fluid">
            <div class="mt-4 row">
                <div class="col-12">
                    <div class="card">
                        <img src="./resources/assets/admin/img/header-blue-white.png" alt="pattern-lines"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="evaluation"
                                                id="evaluation-good" value="Tốt">
                                            <label class="form-check-label" for="evaluation-good">Tốt</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="evaluation"
                                                id="evaluation-fair" value="Khá">
                                            <label class="form-check-label" for="evaluation-fair">Khá</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="evaluation"
                                                id="evaluation-poor" value="Yếu">
                                ...
                                <div class="mt-3 row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="Feedback về tình hình học tập-Block 1-SPRING 2024                                        ">
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <label>Lớp học</label>
                                        <select class="form-control" name="choices-class" id="choices-class" multiple>
                                            <option value="Choice 1" selected>WD18301</option>
                                            <option value="Choice 2">WD18302</option>
                                            <option value="Choice 3">WD18303</option>
                                            <option value="Choice 4">WD18303</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mt-3 row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <select class="form-control" name="choices-multiple-remove-button"
                                            ...
                                            <option value="Choice 1" selected>HTML5 & CSS3</option>
                                            <option value="Choice 2">Lập trình Web</option>
                                            <option value="Choice 3">Javascript nâng cao</option>
                                            <option value="Choice 4">Java cơ bản</option>
                                        </select>
                                    </div>
                                    <div class="mt-3 col-12 col-sm-6 mt-sm-0">
                                        <label>Khóa học </label>
                                        <select class="form-control" name="choices-course" id="choices-course" multiple>
                                            <option value="Choice 1" selected>18</option>
                                            <option value="Choice 2">17</option>
                                            <option value="Choice 3">16</option>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1">
                                            <option>Có hoặc không</option>
                                            <option>Từ giỏi đến kém</option>
                                            <option>Ý kiến của sinh viên</option>
                                        </select>
                                    </div>
                                    <div class="mt-3 col-12 col-sm-6 mt-sm-0">
